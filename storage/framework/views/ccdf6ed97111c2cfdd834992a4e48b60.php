...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Carteiras']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Carteiras']); ?>
    <style>
        .exchange-btn {
...
<?php endif; ?>
            ...
            <div class="overflow-visible" style="min-height: 200px;">
                <table class="w-full">
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $carteiras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carteira): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                <td class="px-6 py-4" style="width: 20%;">
                                    <div>
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($carteira['nome']); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($carteira['tipo']); ?></p>
                                    </div>
                                </td>
                                <td class="px-6 py-4" style="width: 25%;">
                                    <div>
                                        <p class="text-sm text-gray-900"><?php echo e($carteira['operacoes']); ?> operações</p>
                                        <p class="text-xs text-gray-500"><?php echo e($carteira['ultima_sync']); ?></p>
                                    </div>
                                </td>
                                <td class="px-6 py-4" style="width: 25%;">
                                    <div>
                                        <p class="text-sm text-gray-900"><?php echo e($carteira['status']); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e($carteira['status_tempo']); ?></p>
                                    </div>
                                </td>
                                <td class="px-6 py-4" style="width: 20%;">
                                    <p class="text-sm text-gray-900">R$ <?php echo e(number_format($carteira['saldo'], 2, ',', '.')); ?></p>
                                </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['type' => 'text','name' => 'search_platform','placeholder' => 'Pesquisar','iconRight' => 'search','rounded' => 'full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'search_platform','placeholder' => 'Pesquisar','iconRight' => 'search','rounded' => 'full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="flex justify-center items-center gap-6 py-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $plataformas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plataforma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                type="button"
                                @click="selectPlatform('<?php echo e($plataforma['nome']); ?>')"
                                :class="selectedPlatform === '<?php echo e($plataforma['nome']); ?>' ? 'selected' : ''"
                                class="exchange-btn"
                            >
                                <img src="<?php echo e(asset('assets/images/exchanges/' . $plataforma['logo'] . '.png')); ?>" alt="<?php echo e($plataforma['nome']); ?>">
                                <span class="text-[10px] text-gray-600 text-center leading-tight mt-1"><?php echo e($plataforma['nome']); ?></span>
                            </button>
            ...
            >
                ...
                <div class="px-6 py-5">
                    ...
                    <div class="mb-5">
                        ...
                        <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['type' => 'text','name' => 'wallet_name','placeholder' => 'Ex: Minha Binance Principal','rounded' => 'full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'wallet_name','placeholder' => 'Ex: Minha Binance Principal','rounded' => 'full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46)): ?>
<?php $attributes = $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46; ?>
        ...
        >
            ...
            >
                ...
                <div class="px-6 py-5 space-y-4">
                    ...
                    <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['type' => 'text','name' => 'api_key','label' => 'API KEY','placeholder' => 'Digite a chave API','rounded' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'api_key','label' => 'API KEY','placeholder' => 'Digite a chave API','rounded' => 'lg']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46)): ?>
<?php $attributes = $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46; ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['type' => 'password','name' => 'api_secret','label' => 'API SECRET','placeholder' => 'Digite a chave secreta','rounded' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','name' => 'api_secret','label' => 'API SECRET','placeholder' => 'Digite a chave secreta','rounded' => 'lg']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46)): ?>
<?php $attributes = $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46; ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal65bd7e7dbd93cec773ad6501ce127e46 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['type' => 'date','name' => 'start_date','label' => 'Data inicial','placeholder' => 'Selecione a data','rounded' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'date','name' => 'start_date','label' => 'Data inicial','placeholder' => 'Selecione a data','rounded' => 'lg']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46)): ?>
<?php $attributes = $__attributesOriginal65bd7e7dbd93cec773ad6501ce127e46; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\marcu\fiscalwallet\resources\views/carteiras.blade.php ENDPATH**/ ?>