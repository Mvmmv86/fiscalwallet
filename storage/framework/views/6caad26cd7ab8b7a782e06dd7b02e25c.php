...
<div <?php echo e($attributes->merge(['class' => "bg-white rounded-2xl border border-gray-100 {$shadowClass} {$paddingClass}"])); ?>>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title || isset($header)): ?>
        <div class="flex items-center justify-between <?php echo e($title ? 'mb-4' : ''); ?>">
            <div>
...
<?php /**PATH C:\Users\marcu\fiscalwallet\resources\views/components/ui/card.blade.php ENDPATH**/ ?>