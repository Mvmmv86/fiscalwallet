...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Visao geral']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Visao geral']); ?>
    <?php
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.chart','data' => ['class' => 'w-4 h-4 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.info','data' => ['class' => 'w-4 h-4 text-white/70 hover:text-white transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-white/70 hover:text-white transition-colors']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div style="margin-top: 12px;">
                ...
                <p style="font-size: 18px; font-weight: bold; margin-top: 4px;">R$ <?php echo e(number_format($dashboardData['resultado_mes'], 2, ',', '.')); ?></p>
            </div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.trending-up','data' => ['class' => 'w-4 h-4 text-gray-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="relative" x-data="{ showTooltip: false }">
                    <button @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" class="cursor-pointer">
                        <?php if (isset($component)) { $__componentOriginaldfb2872b9aeea0f6148ef7a304b1dcce = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldfb2872b9aeea0f6148ef7a304b1dcce = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.info','data' => ['class' => 'w-4 h-4 text-gray-400 hover:text-primary-500 transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.info'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 text-gray-400 hover:text-primary-500 transition-colors']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldfb2872b9aeea0f6148ef7a304b1dcce)): ?>
<?php $attributes = $__attributesOriginaldfb2872b9aeea0f6148ef7a304b1dcce; ?>
...
<?php endif; ?>
            ...
            <div style="margin-top: 12px;">
                ...
                <p style="font-size: 18px; font-weight: bold; color: #111827; margin-top: 4px;">R$ <?php echo e(number_format($dashboardData['total_ganhos'], 2, ',', '.')); ?></p>
            </div>
        </div>
        ...
        <div class="flex-1 min-w-[200px] bg-white rounded-xl p-4 border border-gray-100">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                <div style="background: #f3f4f6; padding: 8px; border-radius: 8px;">
                    <?php if (isset($component)) { $__componentOriginal7641b966501907875fc7f6e603b08c8a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7641b966501907875fc7f6e603b08c8a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.trending-down','data' => ['class' => 'w-4 h-4 text-gray-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.trending-down'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal7641b966501907875fc7f6e603b08c8a)): ?>
<?php $attributes = $__attributesOriginal7641b966501907875fc7f6e603b08c8a; ?>
<?php unset($__attributesOriginal7641b966501907875fc7f6e603b08c8a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal7641b966501907875fc7f6e603b08c8a)): ?>
<?php $component = $__componentOriginal7641b966501907875fc7f6e603b08c8a; ?>
<?php unset($__componentOriginal7641b966501907875fc7f6e603b08c8a); ?>
<?php endif; ?>
                </div>
                <div class="relative" x-data="{ showTooltip: false }">
                    <button @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" class="cursor-pointer">
...
<?php endif; ?>
            ...
            <div style="margin-top: 12px;">
                ...
                <p style="font-size: 18px; font-weight: bold; color: #111827; margin-top: 4px;">R$ <?php echo e(number_format($dashboardData['total_perdas'], 2, ',', '.')); ?></p>
            </div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.list','data' => ['class' => 'w-4 h-4 text-gray-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            ...
            <div style="margin-top: 12px;">
                ...
                <p style="font-size: 18px; font-weight: bold; color: #111827; margin-top: 4px;"><?php echo e($dashboardData['operacoes_realizadas']); ?></p>
            </div>
        </div>
    </div>
            ...
            <div style="display: flex; align-items: center; gap: 4px; margin-bottom: 2px;">
                ...
                <div class="relative" x-data="{ showTooltip: false }">
                    <button @mouseenter="showTooltip = true" @mouseleave="showTooltip = false" class="cursor-pointer">
                        <?php if (isset($component)) { $__componentOriginaldfb2872b9aeea0f6148ef7a304b1dcce = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldfb2872b9aeea0f6148ef7a304b1dcce = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.info','data' => ['class' => 'w-3 h-3 text-gray-400 hover:text-primary-500 transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.info'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-3 h-3 text-gray-400 hover:text-primary-500 transition-colors']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldfb2872b9aeea0f6148ef7a304b1dcce)): ?>
<?php $attributes = $__attributesOriginaldfb2872b9aeea0f6148ef7a304b1dcce; ?>
...
<?php endif; ?>
            ...
            <p style="font-size: 20px; font-weight: bold; color: #111827; margin-bottom: 8px;">R$ <?php echo e(number_format($dashboardData['valor_consolidado'], 2, ',', '.')); ?></p>
        ...
        <div class="bg-white rounded-xl p-4 border border-gray-100 flex flex-col" style="flex: 4 1 280px; min-width: 250px;">
            ...
            <div style="text-align: center; padding-bottom: 12px; border-bottom: 1px solid #f0f0f0; margin-bottom: 12px;">
                ...
                <p style="font-size: 14px; font-weight: 600; color: #111827;">R$<?php echo e(number_format($dashboardData['limite_isencao_usado'], 0, ',', '.')); ?>/R$ <?php echo e(number_format($dashboardData['limite_isencao_total'], 0, ',', '.')); ?></p>
            </div>

            <div style="text-align: center; padding-bottom: 12px; border-bottom: 1px solid #f0f0f0; margin-bottom: 12px;">
                <p style="font-size: 10px; color: #6b7280; margin-bottom: 4px;">Imposto devido:</p>
                <p style="font-size: 14px; font-weight: 600; color: #111827;">R$<?php echo e(number_format($dashboardData['imposto_devido'], 2, ',', '.')); ?></p>
            </div>

            <div style="text-align: center; padding-bottom: 12px; border-bottom: 1px solid #f0f0f0; margin-bottom: 12px;">
                <p style="font-size: 10px; color: #6b7280; margin-bottom: 4px;">Proxima data para envio de declaracao:</p>
                <p style="font-size: 14px; font-weight: 600; color: #111827;"><?php echo e($dashboardData['proxima_declaracao']); ?></p>
            </div>

            <div style="text-align: center; margin-bottom: 12px;">
                <p style="font-size: 10px; color: #6b7280; margin-bottom: 4px;">Operacoes no periodo</p>
                <p style="font-size: 14px; font-weight: 600; color: #111827;">R$ <?php echo e(number_format($dashboardData['operacoes_periodo'], 2, ',', '.')); ?></p>
            </div>
        ...
        <div
            class="rounded-xl"
            style="width: 200px; align-self: stretch; background-image: url('<?php echo e(asset('assets/images/Banner_invest_dashboar.png')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;"
        ></div>
    </div>
        ...
        <div class="bg-white rounded-xl p-6 border border-gray-100 flex flex-col" style="flex: 1 1 400px; min-width: 350px; min-height: 320px;">
            ...
            <div style="display: flex; gap: 32px; align-items: center; flex: 1;">
                ...
                <div style="flex: 1; display: flex; flex-direction: column; justify-content: center; gap: 18px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $distribuicaoAtivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ativo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <span style="width: 10px; height: 10px; border-radius: 50%; background: <?php echo e($ativo['cor']); ?>;"></span>
                                <span style="font-size: 13px; color: #6b7280;"><?php echo e($ativo['nome']); ?></span>
                            </div>
                            <span style="font-size: 13px; font-weight: 500; color: #111827;">R$ <?php echo e(number_format($ativo['valor'], 2, ',', '.')); ?></span>
                        </div>
        ...
        <div class="bg-white rounded-xl p-6 border border-gray-100 overflow-hidden flex flex-col" style="flex: 1 1 500px; min-width: 400px; min-height: 320px;">
            ...
            <div style="overflow-x: auto; flex: 1; display: flex; flex-direction: column;">
                <table style="width: 100%; border-collapse: collapse; min-width: 450px;">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $ultimasOperacoes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="border-bottom: 1px solid #f9fafb;">
                                <td style="font-size: 12px; color: #111827; padding: 18px 0;">R$ <?php echo e(number_format($operacao['valor'], 2, ',', '.')); ?></td>
                                <td style="font-size: 12px; color: #6b7280; padding: 18px 0;"><?php echo e($operacao['moeda']); ?></td>
                                <td style="font-size: 12px; color: #6b7280; padding: 18px 0;"><?php echo e($operacao['taxa']); ?> USD</td>
                                <td style="font-size: 12px; color: #6b7280; padding: 18px 0;"><?php echo e($operacao['data']); ?></td>
                                <td style="padding: 18px 0;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($operacao['tipo'] === 'entrada'): ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            new Chart(donutCtx, {
                type: 'doughnut',
                data: {
                    labels: <?php echo json_encode(array_column($distribuicaoAtivos, 'nome'), 512) ?>,
                    datasets: [{
                        data: <?php echo json_encode(array_column($distribuicaoAtivos, 'valor'), 512) ?>,
                        backgroundColor: <?php echo json_encode(array_column($distribuicaoAtivos, 'cor'), 512) ?>,
                        borderWidth: 0,
                    }]
                },
                options: {
...
<?php endif; ?>
<?php /**PATH C:\Users\marcu\fiscalwallet\resources\views/dashboard.blade.php ENDPATH**/ ?>