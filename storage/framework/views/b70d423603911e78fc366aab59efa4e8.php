...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.onboarding','data' => ['title' => 'Selecione a plataforma','step' => 2]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Selecione a plataforma','step' => 2]); ?>
    <style>
        .exchange-btn {
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.input','data' => ['type' => 'text','name' => 'search','placeholder' => 'Pesquisar','iconRight' => 'search','rounded' => 'full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'search','placeholder' => 'Pesquisar','iconRight' => 'search','rounded' => 'full']); ?>
...
<?php endif; ?>
        ...
        <div class="flex flex-wrap justify-center gap-3">
            ...
            <button
                ...
                class="exchange-btn"
            >
                <img src="<?php echo e(asset('assets/images/exchanges/binance.png')); ?>" alt="Binance">
            </button>
            ...
            <button
                ...
                class="exchange-btn"
            >
                <img src="<?php echo e(asset('assets/images/exchanges/coinbase.png')); ?>" alt="Coinbase">
            </button>
            ...
            <button
                ...
                class="exchange-btn"
            >
                <img src="<?php echo e(asset('assets/images/exchanges/metamask.png')); ?>" alt="MetaMask">
            </button>
        </div>
        ...
        <div class="flex justify-end w-full max-w-md">
            <a
                ...
                :href="`<?php echo e(url('onboarding/connect')); ?>/` + selectedExchange"
...
<?php endif; ?>
<?php /**PATH C:\Users\marcu\fiscalwallet\resources\views/onboarding/select-platform.blade.php ENDPATH**/ ?>